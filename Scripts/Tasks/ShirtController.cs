...
public class ShirtController : MonoBehaviour
{
    ...
    private List<ShirtStepLog> stepLogs = new List<ShirtStepLog>();
    ...
    IEnumerator RunShirtSequence()
    {
        ...
        if (recorder != null)
            recorder.BeginRecording("Shirt");

        yield return StartCoroutine(RunAndLogStep(OrientTShirt(), "OrientTShirt"));
        yield return StartCoroutine(RunAndLogStep(TShirtOnBedDressLeftArm(), "TShirtOnBedDressLeftArm"));
        yield return StartCoroutine(RunAndLogStep(TShirtOnBedDressRightArm(), "TShirtOnBedDressRightArm"));
        yield return StartCoroutine(RunAndLogStep(TShirtOnBedTShirtOverHead(), "TShirtOnBedTShirtOverHead"));
        yield return StartCoroutine(RunAndLogStep(TShirtOnBedPullTShirtDown(), "TShirtOnBedPullTShirtDown"));
    ...
    // === Step 2 ===
    IEnumerator TShirtOnBedDressLeftArm()
    {
    ...
    // === Step 3 ===
    IEnumerator TShirtOnBedDressRightArm()
    {
    ...
    // === Step 5 ===
    IEnumerator TShirtOnBedPullTShirtDown()
    {
    ...
    IEnumerator RunAndLogStep(IEnumerator coroutine, string taskName)
    {
        ...
        ShirtStepLog log = new ShirtStepLog
        {
